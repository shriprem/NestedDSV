...
### Jump to Field
![Jump_to_Field_list](https://raw.githubusercontent.com/shriprem/NestedDSV/master/images/jump_to_field_with_list.png)
...
### Hop Field
![Jump_to_Field_list](https://raw.githubusercontent.com/shriprem/NestedDSV/master/images/field_navigation.png)
...
#### Right Hop action
The action of Right Hop is dependent on the state of the [Hop Right: Move to the left edge of the following field](https://github.com/shriprem/NestedDSV/blob/master/docs/preferences_dialog.md#hop-right-move-to-the-left-edge-of-the-following-field-default-unchecked) checkbox in the Preferences dialog.
 * When the [Hop Right: Move to the left edge of the following field](https://github.com/shriprem/NestedDSV/blob/master/docs/preferences_dialog.md#hop-right-move-to-the-left-edge-of-the-following-field-default-unchecked) option is unchecked:
 ...
 * When the [Hop Right: Move to the left edge of the following field](https://github.com/shriprem/NestedDSV/blob/master/docs/preferences_dialog.md#hop-right-move-to-the-left-edge-of-the-following-field-default-unchecked) option is checked:
    * The cursor will move to the left edge of the following field within the same record.


See also: [Field Copy and Field Paste](https://github.com/shriprem/NestedDSV/blob/master/docs/field_copy_paste.md) | [Preferences: Hop Right](https://github.com/shriprem/NestedDSV/blob/master/docs/preferences_dialog.md#hop-right-move-to-the-left-edge-of-the-following-field-default-unchecked) | [Menu Item Keyboard Shortcuts](https://github.com/shriprem/NestedDSV/blob/master/docs/menu_shortcuts.md)
