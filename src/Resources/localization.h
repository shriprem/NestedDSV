...
// Common
#define MENU_PANEL_NAME             L"Nested DSV Viewer"
#define MENU_SHOW_PANEL             L"Show Nested DSV &Viewer Panel"
...
#define VIZ_PANEL_DARKMODE_CHANGED  L"Please restart Notepad++ to refresh the Nested DSV Viewer plugin panel and dialogs with the changed Darkmode settings."
...
#define CUR_POS_DATA_REC_FIELD_NUM  L"Record Field#: "
#define CUR_POS_DATA_CUR_DEFINED    L" [Cursor/Defined]"
...
#define ABOUT_PLUGIN_NAME           L"Nested DSV Viewer Plugin for Notepad++"
#define ABOUT_BTN_LABEL_OK          L"&OK"


// Configuration Dialog
#define NDVIZ_DEF_DIALOG_TITLE      L"File Type Metadata Editor"
#define NDVIZ_DEF_FILE_GROUP_BOX    L"File Type"
#define NDVIZ_DEF_FILE_MOVE_DOWN    L"Move down the selected File Type"
#define NDVIZ_DEF_FILE_MOVE_UP      L"Move up the selected File Type"
#define NDVIZ_DEF_FILE_DESC_LABEL   L"File Type - Label:"
#define NDVIZ_DEF_FILE_DELIM_LABEL  L"File Type - Records Terminator:"
#define NDVIZ_DEF_FILE_DELIM_OTHER  L"Manually entered delimiter"
#define NDVIZ_DEF_ADFT_GROUP_LABEL  L"Auto-Detect File Type"
#define NDVIZ_DEF_ADFT_LINE_LABEL   L"Line No:"
#define NDVIZ_DEF_ADFT_REGEX_LABEL  L"Line Regex:"
#define NDVIZ_DEF_FILE_THEME_LABEL  L"File Type - Color Theme:"
#define NDVIZ_DEF_FILE_ACCEPT_BTN   L"Accept"
#define NDVIZ_DEF_FILE_RESET_BTN    L"Reset"
#define NDVIZ_DEF_FILE_NEW_BTN      L"New"
#define NDVIZ_DEF_FILE_CLONE_BTN    L"Clone"
#define NDVIZ_DEF_FILE_DEL_BTN      L"Delete"
#define NDVIZ_DEF_REC_GROUP_BOX     L"File Type » Record Types"
#define NDVIZ_DEF_REC_MOVE_DOWN     L"Move down the selected Record Type"
#define NDVIZ_DEF_REC_MOVE_UP       L"Move up the selected Record Type"
#define NDVIZ_DEF_REC_DESC_LABEL    L"Record Type - Label:"
#define NDVIZ_DEF_REC_START_LABEL   L"Record Type - Starts With:"
#define NDVIZ_DEF_REC_REGEX_LABEL   L"Record Type - Regex Key:"
#define NDVIZ_DEF_REC_THEME_LABEL   L"Record Type - Color Theme:"
#define NDVIZ_DEF_REC_THEME_FROM_FT L"[Use File Type - Color Theme]"
#define NDVIZ_DEF_REC_ACCEPT_BTN    L"Accept"
#define NDVIZ_DEF_REC_RESET_BTN     L"Reset"
#define NDVIZ_DEF_REC_NEW_BTN       L"New"
#define NDVIZ_DEF_REC_CLONE_BTN     L"Clone"
#define NDVIZ_DEF_REC_DEL_BTN       L"Delete"
#define NDVIZ_DEF_FIELD_GROUP_BOX   L"Record Type » Field Labels:"
#define NDVIZ_DEF_FIELD_ACCEPT_BTN  L"Accept"
#define NDVIZ_DEF_FIELD_RESET_BTN   L"Reset"
#define NDVIZ_DEF_FIELD_TYPE_BTN    L"&Define Field Types"
#define NDVIZ_DIALOG_SAVE_BTN       L"&Save as Primary Configuration"
#define NDVIZ_DIALOG_RESET_BTN      L"&Reload Primary Configuration"
#define NDVIZ_DIALOG_BKUP_LOAD_BTN  L"&Load Backup Configuration"
#define NDVIZ_DIALOG_BKUP_VIEW_BTN  L"&View Backup Folder"
#define NDVIZ_DIALOG_EXTRACT_BTN    L"E&xtract Selected File Type Data"
#define NDVIZ_DIALOG_APPEND_BTN     L"&Append New File Type Data"
#define NDVIZ_DIALOG_CLOSE_BTN      L"&Close"

#define UTILS_REGEX_ERROR           L"Invalid Regular Expression"
#define NDVIZ_DIALOG_NUMERIC_TITLE  L"Numbers only!"
#define NDVIZ_DIALOG_NUMERIC_MSG    L"This edit field will only accept numbers,\r\nwith an optional leading minus sign."
#define NDVIZ_DIALOG_COMMAS_TITLE   L"Commas are item separators"
#define NDVIZ_DIALOG_COMMAS_MESSAGE L"The line will be split into multiple items when the 'Accept' button below is clicked."
#define NDVIZ_DISCARD_CHANGES       L"Discard changes?"
#define NDVIZ_DEFAULT_OVERWRITE     L"Save the Default Configuration changes as the Primary Configuration?"
#define NDVIZ_OPEN_BKUP_CONFIG_DLG  L"Open Backup Configuration File"
#define NDVIZ_SAVE_BKUP_CONFIG_DLG  L"Save Backup Configuration File"
#define NDVIZ_FT_NEW_ACTION         L"Add New File Type"
#define NDVIZ_FT_CLONE_ACTION       L"Clone Selected File Type"
#define NDVIZ_FT_APPEND_ACTION      L"Append File Type(s)"
#define NDVIZ_FT_LIMIT_ERROR        L"Only %i File Types can be defined."
#define NDVIZ_RT_NEW_ACTION         L"Add New Record Types"
#define NDVIZ_RT_CLONE_ACTION       L"Clone Selected Record Types"
#define NDVIZ_RT_LIMIT_ERROR        L"Only %i Record Types can be defined per File Type."
#define NDVIZ_DEF_ADFT_HINT_TITLE   L"ADFT in a Nutshell"
#define NDVIZ_DEF_ADFT_HINT_TEXT    L"1. Line Numbers begin at '1', counting forwards from the start of file. Negative line numbers will count backwards from the end of file. Zero and numbers (+ve or -ve) beyond file line count will fail ADFT matching.\r\n\r\n2. ADFT Regexes with no terminating '$' will be used as *starts-with* match. Whereas, those with terminating '$' will be used as *full-line* match. ADFT Regexes will have an implicit caret(^) at the start if it has not been explicitly included.\r\n\r\nClick the (i) icon to view the online ADFT documentation."
#define NDVIZ_DEF_RECTHEME_HINT_HDR L"Record-type Theme"
#define NDVIZ_DEF_RECTHEME_HINT_TXT L"Specify a different color theme than the file-type theme for select-few record types to make them distinctive.\r\n\r\nFor an example, see: 'Transaction Headers' inside the Samples » Treasury IPAC file.\r\n\r\nClick the (i) icon to view the online documentation."
