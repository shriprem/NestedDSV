...
// Common
#define MENU_PANEL_NAME             L"Multi-CSV Viewer"
#define MENU_SHOW_PANEL             L"Show Multi-CSV &Viewer Panel"
...
// Multi-CSV Viewer Panel
#define VIZ_PANEL_FILETYPE_LABEL    L"&File Type:"
#define VIZ_PANEL_THEME_LABEL       L"&Viewer Theme:"
...
#define VIZ_PANEL_DARKMODE_CHANGED  L"Please restart Notepad++ to refresh the Multi-CSV Viewer plugin panel and dialogs with the changed Darkmode settings."
...
#define ABOUT_PLUGIN_NAME           L"Multi-CSV Viewer Plugin for Notepad++"
#define ABOUT_BTN_LABEL_OK          L"&OK"


// Configuration Dialog
#define MCVIZ_DEF_DIALOG_TITLE      L"File Type Metadata Editor"
#define MCVIZ_DEF_FILE_GROUP_BOX    L"File Type"
...
#define MCVIZ_DEF_MCBS_CHECKBOX     L"Multi-byte Character Data"
...
#define MCVIZ_DEF_FILE_THEME_LABEL  L"File Type - Color Theme:"
#define MCVIZ_DEF_FILE_ACCEPT_BTN   L"Accept"
#define MCVIZ_DEF_FILE_RESET_BTN    L"Reset"
#define MCVIZ_DEF_FILE_NEW_BTN      L"New"
#define MCVIZ_DEF_FILE_CLONE_BTN    L"Clone"
#define MCVIZ_DEF_FILE_DEL_BTN      L"Delete"
#define MCVIZ_DEF_REC_GROUP_BOX     L"File Type » Record Types"
#define MCVIZ_DEF_REC_MOVE_DOWN     L"Move down the selected Record Type"
#define MCVIZ_DEF_REC_MOVE_UP       L"Move up the selected Record Type"
#define MCVIZ_DEF_REC_DESC_LABEL    L"Record Type - Label:"
#define MCVIZ_DEF_REC_START_LABEL   L"Record Type - Starts With:"
#define MCVIZ_DEF_REC_REGEX_LABEL   L"Record Type - Regex Key:"
#define MCVIZ_DEF_REC_THEME_LABEL   L"Record Type - Color Theme:"
#define MCVIZ_DEF_REC_THEME_FROM_FT L"[Use File Type - Color Theme]"
#define MCVIZ_DEF_REC_ACCEPT_BTN    L"Accept"
#define MCVIZ_DEF_REC_RESET_BTN     L"Reset"
#define MCVIZ_DEF_REC_NEW_BTN       L"New"
#define MCVIZ_DEF_REC_CLONE_BTN     L"Clone"
#define MCVIZ_DEF_REC_DEL_BTN       L"Delete"
#define MCVIZ_DEF_FIELD_GROUP_BOX   L"Record Type » Fields"
#define MCVIZ_DEF_FIELD_LABELS_TEXT L"Field Labels:"
#define MCVIZ_DEF_FIELD_WIDTHS_TEXT L"Widths:"
#define MCVIZ_DEF_FIELD_ACCEPT_BTN  L"Accept"
#define MCVIZ_DEF_FIELD_RESET_BTN   L"Reset"
#define MCVIZ_DEF_FIELD_TYPE_BTN    L"&Define Field Types"
#define MCVIZ_DIALOG_SAVE_BTN       L"&Save as Primary Configuration"
#define MCVIZ_DIALOG_RESET_BTN      L"&Reload Primary Configuration"
#define MCVIZ_DIALOG_BKUP_LOAD_BTN  L"&Load Backup Configuration"
#define MCVIZ_DIALOG_BKUP_VIEW_BTN  L"&View Backup Folder"
#define MCVIZ_DIALOG_EXTRACT_BTN    L"E&xtract Selected File Type Data"
#define MCVIZ_DIALOG_APPEND_BTN     L"&Append New File Type Data"
#define MCVIZ_DIALOG_CLOSE_BTN      L"&Close"

#define UTILS_REGEX_ERROR           L"Invalid Regular Expression"
#define MCVIZ_DIALOG_NUMERIC_TITLE  L"Numbers only!"
#define MCVIZ_DIALOG_NUMERIC_MSG    L"This edit field will only accept numbers,\r\nwith an optional leading minus sign."
#define MCVIZ_DIALOG_COMMAS_TITLE   L"Commas are item separators"
#define MCVIZ_DIALOG_COMMAS_MESSAGE L"The line will be split into multiple items when the 'Accept' button below is clicked."
#define MCVIZ_DISCARD_CHANGES       L"Discard changes?"
#define MCVIZ_DEFAULT_OVERWRITE     L"Save the Default Configuration changes as the Primary Configuration?"
#define MCVIZ_OPEN_BKUP_CONFIG_DLG  L"Open Backup Configuration File"
#define MCVIZ_SAVE_BKUP_CONFIG_DLG  L"Save Backup Configuration File"
#define MCVIZ_FT_NEW_ACTION         L"Add New File Type"
#define MCVIZ_FT_CLONE_ACTION       L"Clone Selected File Type"
#define MCVIZ_FT_APPEND_ACTION      L"Append File Type(s)"
#define MCVIZ_FT_LIMIT_ERROR        L"Only %i File Types can be defined."
#define MCVIZ_RT_NEW_ACTION         L"Add New Record Types"
#define MCVIZ_RT_CLONE_ACTION       L"Clone Selected Record Types"
#define MCVIZ_RT_LIMIT_ERROR        L"Only %i Record Types can be defined per File Type."
#define MCVIZ_DEF_MCBS_HINT_TITLE   L"Multi-byte Character Data"
#define MCVIZ_DEF_MCBS_HINT_TEXT    L"1. Check this box only if the file type is likely to contain multi-byte character data.\r\n\r\n2. When this box is checked, field widths will be calculated using character counts. And, TABs will be counted as multiple spaces (or characters).\r\n\r\n3. When this box is unchecked, field widths will be calculated using byte counts.\r\n\r\nClick the (i) icon to view the online documentation."
#define MCVIZ_DEF_ADFT_HINT_TITLE   L"ADFT in a Nutshell"
#define MCVIZ_DEF_ADFT_HINT_TEXT    L"1. Line Numbers begin at '1', counting forwards from the start of file. Negative line numbers will count backwards from the end of file. Zero and numbers (+ve or -ve) beyond file line count will fail ADFT matching.\r\n\r\n2. ADFT Regexes with no terminating '$' will be used as *starts-with* match. Whereas, those with terminating '$' will be used as *full-line* match. ADFT Regexes will have an implicit caret(^) at the start if it has not been explicitly included.\r\n\r\nClick the (i) icon to view the online ADFT documentation."
#define MCVIZ_DEF_RECTHEME_HINT_HDR L"Record-type Theme"
#define MCVIZ_DEF_RECTHEME_HINT_TXT L"Specify a different color theme than the file-type theme for select-few record types to make them distinctive.\r\n\r\nFor an example, see: 'Transaction Headers' inside the Samples » Treasury IPAC file.\r\n\r\nClick the (i) icon to view the online documentation."
...
// Theme Dialog
#define THEME_DIALOG_TITLE          L"Viewer Theme Editor"
...
#define EXIM_APPEND_THEME_TITLE     L"Append Viewer Theme Data"
#define EXIM_EXTRACT_THEME_TITLE    L"Extract Viewer Theme Data"
#define EXIM_EDIT_THEME_LABEL       L"Viewer Theme Data:"
...
// Info Button Links
#define VIZPANEL_INFO_README        L"https://github.com/shriprem/MultiCSV/blob/master/README.md"
#define VIZPANEL_FOLD_INFO_README   L"https://github.com/shriprem/MultiCSV/blob/master/docs/foldable_record_blocks.md"
#define MCVIZ_DEF_INFO_README       L"https://github.com/shriprem/MultiCSV/blob/master/docs/file_type_config_dialog.md"
#define MCVIZ_DEF_MCBS_INFO_README  L"https://github.com/shriprem/MultiCSV/blob/master/docs/multibyte_character_data.md"
#define MCVIZ_DEF_ADFT_INFO_README  L"https://github.com/shriprem/MultiCSV/blob/master/docs/auto_detect_file_type.md"
#define MCVIZ_RT_THEME_INFO_README  L"https://github.com/shriprem/MultiCSV/blob/master/docs/record_type_theme.md"
#define THEME_DEF_INFO_README       L"https://github.com/shriprem/MultiCSV/blob/master/docs/theme_config_dialog.md"
#define FOLD_DEF_INFO_README        L"https://github.com/shriprem/MultiCSV/blob/master/docs/fold_structs_editor.md"
#define CONFIG_APPEND_INFO_README   L"https://github.com/shriprem/MultiCSV/blob/master/docs/config_append_dialog.md"
#define CONFIG_EXTRACT_INFO_README  L"https://github.com/shriprem/MultiCSV/blob/master/docs/config_extract_dialog.md"
#define FIELD_TYPE_INFO_README      L"https://github.com/shriprem/MultiCSV/blob/master/docs/field_type_dialog.md"
#define DATA_EXTRACT_INFO_README    L"https://github.com/shriprem/MultiCSV/blob/master/docs/data_extract_dialog.md"
#define DATA_EXTRACT_KEYNAV_README  L"https://github.com/shriprem/MultiCSV/blob/master/docs/data_extract_key_shortcuts.md"
