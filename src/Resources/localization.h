...
#define MCVIZ_DEF_FILE_DELIM_LABEL  L"File Type - Records Terminator:"
#define MCVIZ_DEF_FILE_DELIM_CSV    L"Comma Separted Values (CSV)"
#define MCVIZ_DEF_FILE_DELIM_PSV    L"Pipe Separted Values (PSV)"
#define MCVIZ_DEF_FILE_DELIM_TSV    L"TAB Separted Values (TSV)"
#define MCVIZ_DEF_FILE_DELIM_OTHER  L"Manually entered delimiter"
